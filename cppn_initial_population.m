...
function [population,innovation_record]=cppn_initial_population(number_individuals,number_input_nodes,number_output_nodes,vector_connected_input_nodes);
...
for index_individual=1:number_individuals;
   population(index_individual).nodegenes=[1:(number_input_nodes+1+number_output_nodes); % node index
                                           ones(1,number_input_nodes),4,2*ones(1,number_output_nodes); % node type (input,output,bias,hidden)
                                           zeros(1,number_input_nodes),1,zeros(1,number_output_nodes); % node input
                                           zeros(1,number_input_nodes+1+number_output_nodes); % node output
                                           ones(1,number_input_nodes+1+number_output_nodes)]; % activation function
   ...
   population(index_individual).design=[];
end
